...
export declare class Misc extends APIResource {
...
export declare namespace Misc {
    export { type CountryCode as CountryCode, type Currency as Currency, type TaxCategory as TaxCategory, type MiscListSupportedCountriesResponse as MiscListSupportedCountriesResponse, };
}

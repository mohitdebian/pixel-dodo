...
export declare class Licenses extends APIResource {
     ...
     * ```
     */
    activate(body: LicenseActivateParams, options?: Core.RequestOptions): Core.APIPromise<LicenseKeyInstancesAPI.LicenseKeyInstance>;
    /**
     * @example
     * ```ts
...
export declare namespace Licenses {
    export { type LicenseValidateResponse as LicenseValidateResponse, type LicenseActivateParams as LicenseActivateParams, type LicenseDeactivateParams as LicenseDeactivateParams, type LicenseValidateParams as LicenseValidateParams, };
}
